    ...
    if ($quantity > $ticket_data['availableQuantity']) {
        ...
        if ($insert_stmt) {
            ...
            if ($insert_stmt->execute()) {
                ...
                $message = "success:Booking confirmed! Your booking ID is: $bookingID. Total amount: RM " . number_format($totalAmount, 2);
            } else {
        ...
        <div class="container">
            ...
            <?php if (!empty($message)):
                ...
                <div class="message <?php echo $type; ?>" data-reveal
                    style="padding: 1rem; margin-bottom: 2rem; border-radius: 8px; background: <?php echo $type === 'success' ? '#d4edda' : '#f8d7da'; ?>; color: <?php echo $type === 'success' ? '#155724' : '#721c24'; ?>; border: 1px solid <?php echo $type === 'success' ? '#c3e6cb' : '#f5c6cb'; ?>;">
                            ...
                            <div class="form-row">
                                <div class="form-group">
                                    ...
                                    <select id="ticket_type" name="ticket_type" required>
                                        ...
                                        <?php while ($ticket_type = $ticket_types_result->fetch_assoc()): ?>
